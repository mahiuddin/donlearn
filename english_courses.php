...
<body>
                ...
                <nav class="navbar navbar-expand-lg">
                    ...
                    <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                        <ul class="navbar-nav m-auto">
                            ...
                            <li>
                                <a class="active" href="courses.html">Schools <i class="fa fa-chevron-down"></i></a>
    ...
    <section class="page_banner bg_cover" style="background-image: url(assets/images/img4.jpg)">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="banner_content text-center">
                        <h4 class="title">English Courses List</h4>
                        <ul class="breadcrumb justify-content-center">
                            <li><a href="#">Home</a></li>
                            <li><a class="active" href="#">English Courses</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_courses courses_gray mt-30">
                        ...
                        <div class="courses_content">
                            ...
                            <h4 class="title"><a href="#">English - Primary Foundation </a></h4>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_courses courses_gray mt-30">
                        ...
                        <div class="courses_content">
                            ...
                            <h4 class="title"><a href="#">English - Primary Advance </a></h4>
                            <div class="meta d-flex justify-content-between">
                                <ul>
                                    <li><a href="#"><i class="fa fa-user-o"></i> 100</a></li>
                                    <li><a href="#"><i class="fa fa-star-o"></i> 4.5</a></li>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_courses courses_gray mt-30">
                        ...
                        <div class="courses_content">
                            ...
                            <h4 class="title"><a href="#">English - Middle Foundation </a></h4>
                            <div class="meta d-flex justify-content-between">
                                <ul>
                                    <li><a href="#"><i class="fa fa-user-o"></i> 100</a></li>
                                    <li><a href="#"><i class="fa fa-star-o"></i> 4.5</a></li>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_courses courses_gray mt-30">
                        ...
                        <div class="courses_content">
                            ...
                            <h4 class="title"><a href="#">English - Middle Advance </a></h4>
                            <div class="meta d-flex justify-content-between">
                                <ul>
                                    <li><a href="#"><i class="fa fa-user-o"></i> 100</a></li>
                                    <li><a href="#"><i class="fa fa-star-o"></i> 4.5</a></li>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_courses courses_gray mt-30">
                        ...
                        <div class="courses_content">
                            ...
                            <h4 class="title"><a href="#">English - High Foundation </a></h4>
                            <div class="meta d-flex justify-content-between">
                                <ul>
                                    <li><a href="#"><i class="fa fa-user-o"></i> 100</a></li>
                                    <li><a href="#"><i class="fa fa-star-o"></i> 4.5</a></li>
                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="single_courses courses_gray mt-30">
                        ...
                        <div class="courses_content">
                            ...
                            <h4 class="title"><a href="#">English - High Advance </a></h4>
                            <div class="meta d-flex justify-content-between">
                                <ul>
                                    <li><a href="#"><i class="fa fa-user-o"></i> 100</a></li>
                                    <li><a href="#"><i class="fa fa-star-o"></i> 4.5</a></li>
                    ...
                    <div class="col-lg-9">
                        <div class="footer_widget_wrapper d-flex flex-wrap">
                            ...
                            <div class="footer_contact mt-50">
                                <h5 class="footer_title"><a href="#">Nauman</a></h5>
        ...
        <div class="footer_copyright">
            <div class="container">
                <div class="footer_copyright_wrapper text-center d-md-flex justify-content-between">
                    <div class="copyright">
                        <p class="cr">Made with <span class="heart"><i class="fa fa-heart"></i></span> by <a target="_blank" href="https://www.theidioms.com">Idioms</a></p>
                    </div>
                    <div class="copyright">
